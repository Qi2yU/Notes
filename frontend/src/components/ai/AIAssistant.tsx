...
import aiService, { ChatRequest, ChatResponse, ChatMessage } from '../../services/aiService';
    ...
    <Card
      title={
        <Space>
          ...
          <Title level={5} style={{ margin: 0 }}>AI智能助手</Title>
      ...
      <div style={{ 
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '20px' }}>
            <Spin size="small" />
            <Text style={{ marginLeft: '8px', color: '#999' }}>AI正在思考...</Text>
          </div>
        )}
